...
class CSV2Mysql:
    ...
    def migrate_csv_to_mysql(self, bucket: str = None, key: str = None, columns: list = [], default_values: str = "missing",
                     add_primaryKey: bool = False, type_of_insertion: str = 'append', db_table: str = 'table'):
        try:
            df = self.dataFrame_init.prepareCSVdf(bucket=bucket, key=key, columns=columns, default_values=default_values,
